...
exponential shadow mapping in order to get soft, filtered shadows for large levels.
...
but this method uses the level's shadow map, instead of a screen-space depth map.
