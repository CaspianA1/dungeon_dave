...
void load_all_defaults(void (*load_first_level) (void), Player* const player, Weapon* const weapon) {
	...
	const Weapon first_weapon = {
		.flags = mask_paces_sideways_weapon | mask_spawns_projectile_weapon, .power = 8.0,
		.sound = init_sound("rocket.wav", 1), // init_sound("assets/audio/sound_effects/rocket_launch.wav", 1),
