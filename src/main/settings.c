...
void load_all_defaults(void (*load_first_level) (void), Player* const player, Weapon* const weapon) {
	...
	const Weapon first_weapon = {
		.in_use = 0, .short_range = 1, .paces_sideways = 0, .power = 2.0, .dist_for_hit = 0.4,
	...
	/*
	const Weapon first_weapon = {
		.in_use = 0, .short_range = 0, .paces_sideways = 1, .power = 4.0, .dist_for_hit = 0.4,
	...
	*/
	...
	/*
	const Weapon first_weapon = {
		.in_use = 0, .short_range = 1, .paces_sideways = 1, .power = 4.0, .dist_for_hit = 0.4,
