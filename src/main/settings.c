...
void load_all_defaults(void (*load_first_level) (void), Player* const player, Weapon* const weapon) {
	...
	extern const byte mask_short_range, mask_paces_sideways;
	...
	/*
	const Weapon first_weapon = {
		.status = mask_paces_sideways, .power = 6.0, .dist_for_hit = 0.5,
	...
	*/
	...
	/*
	const Weapon first_weapon = {
		.status = mask_short_range | mask_paces_sideways, .power = 4.0, .dist_for_hit = 0.5,
