...
/* Excluded: fail_on_sub_shader_creation_error, init_shader_from_source,
read_file_contents, get_source_for_included_file, read_and_parse_includes_for_glsl,
erase_version_strings_from_dependency_list */
