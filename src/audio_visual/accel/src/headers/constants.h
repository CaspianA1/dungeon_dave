...
static const struct {
	...
	const struct { // All angles are in radians
		const GLfloat eye_height, aabb_collision_box_size, tilt_decel_rate, friction;
	...
	.camera = {
		.eye_height = 0.5f, .aabb_collision_box_size = 0.2f, .tilt_decel_rate = 0.9f, .friction = 7.5f,
